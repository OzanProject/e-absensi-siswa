    ...
    <nav class="text-sm font-medium text-gray-500 bg-white px-4 py-2 rounded-full shadow-sm border border-gray-100"
        ...
        <ol class="flex space-x-2">
            ...
            <li><a href="{{ route('report.index') }}"
                    class="text-indigo-600 hover:text-indigo-800 transition duration-150">Laporan</a></li>
            <li class="text-gray-300">/</li>
...
<div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
    ...
    {{-- CARD HEADER --}}
    <div
        class="p-6 border-b border-gray-100 bg-purple-50/30 flex flex-col lg:flex-row justify-between items-start lg:items-center">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">
                ...
                <span class="font-medium text-gray-700">{{ $startDate->format('d/m/Y') }}</span> s/d <span
                    class="font-medium text-gray-700">{{ $endDate->format('d/m/Y') }}</span>
            </p>
        </div>
        ...
        <div class="flex space-x-3 mt-4 lg:mt-0">
            ...
            <a href="{{ route('report.index') }}"
                class="inline-flex items-center px-4 py-2 text-sm font-bold rounded-xl shadow-sm text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 transition duration-150">
    ...
    <div class="p-0"> {{-- Padding 0 untuk table full width --}}
        @if($absences->isEmpty())
            <div class="p-12 text-center">
                ...
                <p class="text-gray-500 mt-2">Tidak ada data absensi yang sesuai dengan filter periode dan kelas yang Anda
                    pilih.</p>
            </div>
        @else
                ...
                <table class="min-w-full divide-y divide-gray-100">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Jenis</th> {{-- NEW COLUMN --}}
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Detail</th> {{-- RENAMED --}}
                        </tr>
                    </thead>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @php
                                        $statusStyles = [
                                            ...
                                            'Absen' => 'bg-red-100 text-red-700', // Legacy
