...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* === FOOTER & BUTTON (Solusi Tumpang Tindih) === */
        .footer-wrapper {
            background-color: #0d6efd;
            color: white;
            padding: 5px 10px;
        ...
        /* Tombol Cetak diposisikan di tengah bawah */
        .footer-print-button {
            ...
            display: block; /* Tombol sebagai block */
        ...
        @media print {
            ...
            /* Sembunyikan elemen yang tidak perlu dicetak di dalam footer */
...
<body onload="window.print()">
    @php
        ...
        // Format Tanggal Lahir (Menggunakan data yang sudah ditambahkan)
    ...
    <div class="card-container">
        <div class="header">
            <img src="{{ asset('storage/' . ($settings['school_logo'] ?? 'default/logo.png')) }}" alt="Logo Sekolah" class="logo">
        ...
        {{-- FOOTER WRAPPER BARU: Mengandung Teks dan Tombol Cetak --}}
