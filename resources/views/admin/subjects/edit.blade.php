...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
    <div>
        ...
        <p class="text-sm text-gray-500 mt-1">Perbarui informasi mata pelajaran {{ $subject->name }}.</p>
    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative rounded-xl shadow-sm group">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <i
                                        class="fas fa-book text-gray-400 group-focus-within:text-amber-500 transition-colors"></i>
                                </div>
                        ...
                        <div>
                            ...
                            <div class="relative rounded-xl shadow-sm group">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <i
                                        class="fas fa-barcode text-gray-400 group-focus-within:text-amber-500 transition-colors"></i>
                                </div>
    ...
    <div class="lg:col-span-1">
        <div class="bg-amber-50 rounded-3xl p-8 border border-amber-100 h-full">
            <h3 class="text-lg font-bold text-amber-900 mb-4 flex items-center">
                <div class="w-8 h-8 rounded-lg bg-amber-200 flex items-center justify-center mr-3">
            ...
            <div class="space-y-4">
                <div class="p-4 bg-white rounded-2xl shadow-sm border border-amber-100">
                    <h5 class="font-bold text-gray-800 text-sm mb-1">Perubahan Kode</h5>
                    <p class="text-gray-600 text-xs leading-relaxed">
                        Hati-hati saat mengubah kode mata pelajaran jika sistem lain bergantung pada kode ini.
                    </p>
                </div>
                <div class="p-4 bg-white rounded-2xl shadow-sm border border-amber-100">
                    <h5 class="font-bold text-gray-800 text-sm mb-1">Nama Mapel</h5>
                    <p class="text-gray-600 text-xs leading-relaxed">
                        Pastikan nama mata pelajaran konsisten dengan format penamaan di sekolah.
                    </p>
                </div>
            </div>
        </div>
