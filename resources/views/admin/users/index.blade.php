...
<div class="container-fluid px-0">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div
            class="bg-gradient-to-br from-purple-500 to-indigo-600 rounded-2xl p-5 text-white shadow-lg relative overflow-hidden">
            <div class="relative z-10">
                <h4 class="text-3xl font-bold">{{ $totalUsersCount }}</h4>
                <p class="text-purple-100 text-sm font-medium">Total Akun Terdaftar</p>
            </div>
            <i
                class="fas fa-users absolute right-0 bottom-0 opacity-20 text-6xl transform translate-x-2 translate-y-2"></i>
        </div>
        ...
        <div class="p-4 border-b border-gray-100 bg-gray-50/50">
            <div class="flex flex-col lg:flex-row justify-between lg:items-center space-y-4 lg:space-y-0">
                ...
                <div class="flex space-x-1 bg-gray-200/50 p-1 rounded-xl w-full lg:w-auto overflow-x-auto">
                    ...
                    <a href="{{ route('admin.users.index', ['tab' => 'kepala_sekolah', 'search' => request('search')]) }}"
                        class="{{ $tabBase }} {{ $currentTab === 'kepala_sekolah' ? $tabActive : $tabInactive }}">
            ...
            @if($currentTab !== 'super_admin_list')
                <div class="mt-4 flex flex-wrap items-center gap-2 pt-4 border-t border-gray-100">
                    <span id="selected-count"
                        class="text-xs font-bold text-indigo-600 bg-indigo-50 px-3 py-1.5 rounded-lg border border-indigo-100 hidden mr-2">
                        0 Dipilih
                    </span>
                ...
                <thead class="bg-gray-50/80">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Role &
                            Status</th>
                        <th class="px-6 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider w-32">
                            Aksi</th>
                    </tr>
                </thead>
                            ...
                            <td class="px-6 py-4 text-center">
                                @if(!$user->isSuperAdmin())
                                    <input type="checkbox" name="selected_users[]" value="{{ $user->id }}"
                                        class="bulk-checkbox rounded text-purple-600 border-gray-300 focus:ring-purple-500">
                                @endif
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <div
                                            class="h-10 w-10 rounded-full bg-gradient-to-br from-indigo-100 to-purple-100 flex items-center justify-center text-indigo-600 font-bold shadow-inner">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <div class="text-xs text-gray-500">Joined {{ $user->created_at->format('M Y') }}
                                        </div>
                                    </div>
                                </div>
                            </td>
                                ...
                                <div class="flex flex-col space-y-1">
                                    ...
                                    @php
                                        $roleStyles = [
                                            ...
                                            'kepala_sekolah' => 'bg-emerald-100 text-emerald-800 border-emerald-200',
                                    ...
                                    @endphp
                                    <span
                                        class="px-2 py-0.5 inline-flex text-xs leading-5 font-bold rounded-lg border {{ $style }} w-fit">
