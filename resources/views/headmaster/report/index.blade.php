...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
    <div>
        ...
        <p class="text-sm text-gray-500 mt-1 font-medium">Filter dan unduh laporan kehadiran siswa. (Mode Kepala Sekolah)</p>
    </div>
    <nav class="text-sm font-medium text-gray-500 bg-white px-4 py-2 rounded-full shadow-sm border border-gray-100" aria-label="Breadcrumb">
        <ol class="flex space-x-2">
            <li><a href="{{ route('headmaster.dashboard') }}" class="text-indigo-600 hover:text-indigo-800 transition duration-150"><i class="fas fa-home"></i></a></li>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 lg:gap-6">
        ...
        <div class="lg:col-span-3">
            <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    <form action="{{ route('headmaster.report.generate') }}" method="GET" id="filterForm" class="space-y-6">
                        @php
                            $classes = $classes ?? []; 
                    ...
                    <form action="{{ route('headmaster.report.export.excel') }}" method="GET" id="exportForm" class="hidden">
                ...
                <div class="p-6 text-sm space-y-4 text-gray-600">
                    <div class="space-y-3">
                        <div class="flex items-start">
                            ...
                            <div>
                                <strong class="block text-gray-800">Rekap Kelas</strong>
                                <span class="text-xs">Lihat rangkuman instan per kelas.</span>
                                <a href="{{ route('headmaster.report.recap') }}" class="block mt-1 text-indigo-600 font-bold hover:underline">Ke Rekap Kelas &rarr;</a>
                            </div>
                        </div>
                        <div class="flex items-start">
                             <div class="bg-purple-100 p-2 rounded-lg text-purple-600 mr-3 flex-shrink-0">
                            ...
                            <div>
                                ...
                                <span class="text-xs">Pilih kelas dan rentang tanggal untuk melihat data log detail.</span>
                            </div>
                        </div>
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <span class="text-xs">Unduh laporan lengkap dalam format .xlsx.</span>
                            </div>
                        </div>
                    </div>
                </div>
